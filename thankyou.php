<?php
    // Start a session to keep track of user submissions if needed
       session_start();

    // Optionally, you can display a success message based on the previous form submission
       $message = isset($_SESSION['submission_success']) ? $_SESSION['submission_success'] : "Thank you for contacting us! We will get back to you soon.";
       unset($_SESSION['submission_success']); // Clear the message after displaying it
?>
...
<header>
    <h1 style="color: #800000;">Thank You for Contacting Us!</h1>
